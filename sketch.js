...
function preload(){
  ...
  trexIMG = loadImage("dino1.png");    
  trexANI = loadAnimation("dino1.png","dino2.png","dino3.png")
...
function setup() {
  ...
  sun = createSprite(width-70,height-height/1.1,10,10);
  sun.addAnimation("sun", sunIMG);
  sun.scale = 0.5;
  
  trex = createSprite(60,height-70,20,50);
  
  trex.addImage("end",trexIMG);
